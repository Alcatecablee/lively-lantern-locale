        ...
        {LAYER_LIST.map(layer => {
          ...
          return (
            <Toggle
              ...
              className={
                `flex items-center w-full px-3 py-2 rounded-full border-2 transition
            ...
            >
              <span
                className={
                  `inline-flex items-center justify-center w-9 h-9 text-base font-bold rounded-full mr-2 border
                  ${isOn
                    ? "bg-white/30 text-blue-100 border-blue-200"
